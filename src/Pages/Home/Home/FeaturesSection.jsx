      ...
      <div className="max-w-11/12 mx-auto sm:px-4 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <motion.div
            ...
            className="relative bg-base-100 p-8 rounded-3xl border border-base-300 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden"
          >
            ...
            <h3 className="text-lg md:text-xl font-semibold text-base-content text-center mb-3">
